...
file_base = '/home/jericho/1-Workspace/1-jupyter_notebooks/7-fastcat_xcat/test/'
angles = np.linspace(0, np.pi*2, 40, endpoint=False)
fnames = []

Catphan604_phantom.angles = angles
out_dir = '/home/jericho/1-Workspace/1-jupyter_notebooks/7-fastcat_xcat/out_fastmc_flood_only'
sim_dir = '/home/jericho/1-Workspace/1-jupyter_notebooks/7-fastcat_xcat/sim_fastmc_flood_only'
