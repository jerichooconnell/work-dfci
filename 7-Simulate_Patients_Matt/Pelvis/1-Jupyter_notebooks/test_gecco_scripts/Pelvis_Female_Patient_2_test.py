...
phantom = patient_data.patient_phantom('/media/jericho/T7/Clinical_data/Pelvis/Pelvis_Female_Patient_2.nrrd', 1e10, reload=True, sim_num=8)
...
phantom2 = patient_data.patient_phantom('/media/jericho/T7/Clinical_data/Pelvis/Pelvis_Female_Patient_2.nrrd', 1e10, reload=True, sim_num=8, second_layer=True)
