...
nrrd_to_mhd(nrrd_file, force=True, tr=[1, 0, 2], crop=[
            200, 300, 111, 367, None, None])

phantom = patient_data.patient_phantom(
    nrrd_file, 1000000.0, force_materials=False, is_fullfan=False)
...
phantom.run_fastmc(
    fastmc_path='/home/jericho/Downloads/FastMC_Jan_05/FastMC_install/bin/FastMC')
