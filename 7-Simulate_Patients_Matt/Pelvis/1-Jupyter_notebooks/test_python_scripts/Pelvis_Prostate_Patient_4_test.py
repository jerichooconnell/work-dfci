...
nrrd_file = '/home/berbecolab/2-Datadir/Clinical_data/Pelvis/Pelvis_Prostate_Patient_4.nrrd'

# Write to mhd

nrrd_to_mhd(nrrd_file,force=True,tr= [2, 1, 0],crop=[None, 70, None, None, None, None])
