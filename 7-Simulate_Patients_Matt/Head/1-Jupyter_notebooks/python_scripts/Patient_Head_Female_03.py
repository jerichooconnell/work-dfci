...
nrrd_file = '/home/berbecolab/2-Datadir/Clinical_data/Head/Patient_Head_Female_03.nrrd'

# Write to mhd

nrrd_to_mhd(nrrd_file,force=True,tr= [2, 0, 1],crop=[None, None, None, None, None, None])
