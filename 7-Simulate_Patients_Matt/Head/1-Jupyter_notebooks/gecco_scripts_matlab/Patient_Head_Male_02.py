...
phantom = patient_data.patient_phantom('/home/berbecolab/2-Datadir/Clinical_data/Head/Patient_Head_Male_02.nrrd', 1e10, reload=True, sim_num=None)
...
phantom2 = patient_data.patient_phantom('/home/berbecolab/2-Datadir/Clinical_data/Head/Patient_Head_Male_02.nrrd', 1e10, reload=True, sim_num=None, second_layer=True)
...
nrrd_base = 'Patient_Head_Male_02'
