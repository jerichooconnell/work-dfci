...
class Detector_GUI(object):
    ...
    def initialize_gui_lower(self):
        ...
        gui['buttons']['HU'] = Button(gui['buttons']['HU'], 'Plot HU')
    ...
    Filter Spectrum: Filter the spectrum through the detector,
    ...
    HU: Plot the estimated HU values for each layer 
              ~ log(E/E_0) with E being the total energy absorbed in the layer after filtration
              by the material in the text boxes + water padding and E_0 being the 
              total energy absorbed without filtration by the material in the text boxes
              or water padding,
    Change kVp: Change the kVp of the spectrum,
