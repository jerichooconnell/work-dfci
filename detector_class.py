    ...
    class layer(object):
        ...
        def plot_layer(self, axis, color):
            ...
            if self.layer['thickness'] <= 5:
                ...
                axis.annotate(self.layer['material'], xy=(0.5, -self.layer['total_thickness'] + 0.5*self.layer['thickness']),
                                color='k', fontsize=12, ha='center', va='center')
            else:
                axis.add_patch(plt.Rectangle(
                    (0, -self.layer['total_thickness']+5), 1, -5, color=color))
                axis.annotate(self.layer['material'], xy=(0.5, -self.layer['total_thickness'] + 0.5*5),
                              color='k', fontsize=12, ha='center', va='center')
