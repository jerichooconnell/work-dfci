...
nrrd_file = '/home/berbecolab/2-Datadir/Clinical_data/Pelvis/Pelvis_Prostate_Patient_1.nrrd'

# Write to mhd

nrrd_to_mhd(nrrd_file,force=True,tr= [1, 0, 2],crop=[254, None, None, None, None, None])
