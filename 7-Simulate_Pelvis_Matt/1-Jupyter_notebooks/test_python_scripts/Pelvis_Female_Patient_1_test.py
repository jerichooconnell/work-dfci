...
nrrd_file = '/home/jericho/2-Datadir/Clinical_data/Pelvis/Pelvis_Female_Patient_1.nrrd'

# Write to mhd

nrrd_to_mhd(nrrd_file,force=True,tr= [1, 0, 2],crop=[272, 511, 136, 334, None, None])
