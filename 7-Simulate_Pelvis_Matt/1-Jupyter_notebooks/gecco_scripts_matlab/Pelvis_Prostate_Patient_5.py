...
phantom2 = patient_data.patient_phantom('/home/berbecolab/2-Datadir/Clinical_data/Pelvis/Pelvis_Prostate_Patient_5.nrrd', 1e10, reload=True, sim_num=None, second_layer=True)
...
nrrd_base = 'Pelvis_Prostate_Patient_5'
