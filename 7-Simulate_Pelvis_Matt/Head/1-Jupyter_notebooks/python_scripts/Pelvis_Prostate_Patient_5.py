...
nrrd_file = '/home/berbecolab/2-Datadir/Clinical_data/Pelvis/Pelvis_Prostate_Patient_5.nrrd'

# Write to mhd

nrrd_to_mhd(nrrd_file,force=True,tr= [1, 0, 2],crop=[367, None, None, None, None, None])
